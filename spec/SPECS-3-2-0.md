...
**Spec version:** 0.3.1 (historical)
**Status:** superseded by the intentional clean-break 0.4 protocol in
[`SPECS-4-0-0.md`](SPECS-4-0-0.md). This document remains only as the
reference for 0.3 transport, DM, TON-proof, and peer-hygiene behavior explicitly
retained by 0.4. New public-room implementations MUST NOT use the name-derived
identity or volatile public history described below. Historical fixtures in
